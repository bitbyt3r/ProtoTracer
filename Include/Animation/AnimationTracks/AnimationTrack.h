...
template<size_t maxParameters, size_t maxKeyFrames>
	...
	public:
		AnimationTrack()
			: track(KeyFrameTrack<maxParameters, maxKeyFrames>(0.0f, 1.0f, KeyFrameInterpolation::Cosine)) {}
    
		AnimationTrack(float min, float max, KeyFrameInterpolation::InterpolationMethod interpMethod)
			: track(KeyFrameTrack<maxParameters, maxKeyFrames>(min, max, interpMethod)) {}
