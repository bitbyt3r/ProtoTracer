...
SOURCEFILES := Include/Controllers/rpi-led-matrix/lib/bdf-font.cc Include/Controllers/rpi-led-matrix/lib/content-streamer.cc Include/Controllers/rpi-led-matrix/lib/framebuffer.cc Include/Controllers/rpi-led-matrix/lib/gpio.cc Include/Controllers/rpi-led-matrix/lib/graphics.cc Include/Controllers/rpi-led-matrix/lib/hardware-mapping.c Include/Controllers/rpi-led-matrix/lib/led-matrix-c.cc Include/Controllers/rpi-led-matrix/lib/led-matrix.cc Include/Controllers/rpi-led-matrix/lib/multiplex-mappers.cc Include/Controllers/rpi-led-matrix/lib/options-initialize.cc Include/Controllers/rpi-led-matrix/lib/pixel-mapper.cc Include/Controllers/rpi-led-matrix/lib/thread.cc Prototracer.cpp
EXTERNAL_LIBS := 
...
$(BINARYDIR)/bdf-font.o : Include/Controllers/rpi-led-matrix/lib/bdf-font.cc $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/content-streamer.o : Include/Controllers/rpi-led-matrix/lib/content-streamer.cc $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/framebuffer.o : Include/Controllers/rpi-led-matrix/lib/framebuffer.cc $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/gpio.o : Include/Controllers/rpi-led-matrix/lib/gpio.cc $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/graphics.o : Include/Controllers/rpi-led-matrix/lib/graphics.cc $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/hardware-mapping.o : Include/Controllers/rpi-led-matrix/lib/hardware-mapping.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/led-matrix-c.o : Include/Controllers/rpi-led-matrix/lib/led-matrix-c.cc $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/led-matrix.o : Include/Controllers/rpi-led-matrix/lib/led-matrix.cc $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/multiplex-mappers.o : Include/Controllers/rpi-led-matrix/lib/multiplex-mappers.cc $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/options-initialize.o : Include/Controllers/rpi-led-matrix/lib/options-initialize.cc $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/pixel-mapper.o : Include/Controllers/rpi-led-matrix/lib/pixel-mapper.cc $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)


$(BINARYDIR)/thread.o : Include/Controllers/rpi-led-matrix/lib/thread.cc $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) $(CXXFLAGS) -c $< -o $@ $(CC_DEPENDENCY_FILE_SPECIFIER) $(@:.o=.dep)
